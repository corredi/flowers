...
import com.accenture.flowershop.be.entity.jooqent.information_schema.tables.records.ColumnsRecord;
...
public class Columns extends TableImpl<ColumnsRecord> {
    ...
    private static final long serialVersionUID = 1835989527;
     ...
     */
    public final TableField<ColumnsRecord, String> DOMAIN_CATALOG = createField("DOMAIN_CATALOG", org.jooq.impl.SQLDataType.VARCHAR(2147483647), this, "");

    /**
     * The column <code>INFORMATION_SCHEMA.COLUMNS.DOMAIN_SCHEMA</code>.
     */
    public final TableField<ColumnsRecord, String> DOMAIN_SCHEMA = createField("DOMAIN_SCHEMA", org.jooq.impl.SQLDataType.VARCHAR(2147483647), this, "");

    /**
     * The column <code>INFORMATION_SCHEMA.COLUMNS.DOMAIN_NAME</code>.
     */
    public final TableField<ColumnsRecord, String> DOMAIN_NAME = createField("DOMAIN_NAME", org.jooq.impl.SQLDataType.VARCHAR(2147483647), this, "");
     ...
     */
    public final TableField<ColumnsRecord, String> INTERVAL_TYPE = createField("INTERVAL_TYPE", org.jooq.impl.SQLDataType.VARCHAR(2147483647), this, "");
     ...
     */
    public final TableField<ColumnsRecord, String> IS_VISIBLE = createField("IS_VISIBLE", org.jooq.impl.SQLDataType.VARCHAR(2147483647), this, "");
