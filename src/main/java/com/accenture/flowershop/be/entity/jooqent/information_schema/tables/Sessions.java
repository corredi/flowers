...
import com.accenture.flowershop.be.entity.jooqent.information_schema.tables.records.SessionsRecord;
...
public class Sessions extends TableImpl<SessionsRecord> {
    ...
    private static final long serialVersionUID = 1173300686;
     ...
     */
    public final TableField<SessionsRecord, OffsetDateTime> SESSION_START = createField("SESSION_START", org.jooq.impl.SQLDataType.TIMESTAMPWITHTIMEZONE.precision(9), this, "");
     ...
     */
    public final TableField<SessionsRecord, OffsetDateTime> STATEMENT_START = createField("STATEMENT_START", org.jooq.impl.SQLDataType.TIMESTAMPWITHTIMEZONE.precision(9), this, "");

    /**
     * The column <code>INFORMATION_SCHEMA.SESSIONS.CONTAINS_UNCOMMITTED</code>.
     */
    public final TableField<SessionsRecord, Boolean> CONTAINS_UNCOMMITTED = createField("CONTAINS_UNCOMMITTED", org.jooq.impl.SQLDataType.BOOLEAN, this, "");

    /**
     * The column <code>INFORMATION_SCHEMA.SESSIONS.STATE</code>.
     */
    public final TableField<SessionsRecord, String> STATE = createField("STATE", org.jooq.impl.SQLDataType.VARCHAR(2147483647), this, "");

    /**
     * The column <code>INFORMATION_SCHEMA.SESSIONS.BLOCKER_ID</code>.
     */
    public final TableField<SessionsRecord, Integer> BLOCKER_ID = createField("BLOCKER_ID", org.jooq.impl.SQLDataType.INTEGER, this, "");
